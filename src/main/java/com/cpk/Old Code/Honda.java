...
public class Honda {
    ...
    // HONDA RD LH / RD RH CAPABILITY
    static int rowCount;

    public static void main(String[] args) {
        // Path to the existing Excel file
        String filePath = "C:\\Users\\shann\\Documents\\Automating Capability\\Test Template for Automating Capability\\T90 Capability Full Study TEST.xlsx";
        ...
        try {
            ...
            for (String sheetName : sheetNames) {
                ...
                for (int c = 1; c < 12; c++) { // Loop 11 times (11 columns in RH Data)
