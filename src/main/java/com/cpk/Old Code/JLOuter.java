...
public class JLOuter {

    // JL OB FD RD Capabilities
    static int rowCount;
    static int colCount;
    ...
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\shann\\Documents\\Automating Capability\\Test Template for Automating Capability\\JL OB Capability Full Study TEST.xlsx";
